...
\\
After we got the data we needed, we started implementing the algorithms that we thought of. % beschreiben wie der algorithmus von Herr Fischer funktioniert und die 2-3 die wir noch implementiert haben
