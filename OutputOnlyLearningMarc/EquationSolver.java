 ...
 * elimination algorithm * (c) copyright by Jörn Fischer	* *	* @autor:
...
//        System.out.println(matrix[MDims-1][MDims]);
//        System.out.println(matrix[MDims -1][MDims-1]);
//        System.out.println(inVector[MDims-2]);
