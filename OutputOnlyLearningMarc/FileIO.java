...
/**
 * **********************************************************************
 * \brief: Class for File-IO, reads in single values and the table * for the
 * spiral problem * * (c) copyright by Jörn Fischer	* *	* @autor: Prof.Dr.Jörn
 * Fischer
 *
...
public class FileIO {
    ...
    /**
     * @brief: writes a file with the specified filename from the buffer buf to
     * harddisk
     * @param fileName
     * @param buf
     */
